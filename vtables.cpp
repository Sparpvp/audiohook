...
/*
    ...
    4) **audioRenderClient[x] = method pointer | uint64_t
        aka, ***audioRenderClient.
*/
...
/*
    ...
    4) **audioCaptureClient[x] = method pointer | uint64_t
        aka, ***audioCaptureClient.
*/
void** VTables::GetCaptureClientVTable(IAudioCaptureClient* audioCaptureClient)
{
    ...
    //std::cout << "ptr to Capture Interface: " << std::hex << audioCaptureClient << std::endl;
    //std::cout << "ptr to Capture vTable: " << std::hex << captureVTablePtr << std::endl;
    //std::cout << "ptr to Capture GetBuffer: " << std::hex << captureVTablePtr[0] << std::endl;
